...
simulate_emp_cpp <- function(input_population, marker_positions_R, select_R, pop_size, total_runtime, morgan, verbose, track_frequency, track_markers_R, multiplicative_selection, mutation_rate, substitution_matrix_R, num_threads, recombination_map) {
    .Call(`_GenomeAdmixR_simulate_emp_cpp`, input_population, marker_positions_R, select_R, pop_size, total_runtime, morgan, verbose, track_frequency, track_markers_R, multiplicative_selection, mutation_rate, substitution_matrix_R, num_threads, recombination_map)
}
...
simulate_migration_emp_cpp <- function(input_population_1, input_population_2, marker_positions_R, select_R, pop_sizes, total_runtime, morgan, verbose, track_frequency, track_markers_R, multiplicative_selection, migration_rate, mutation_rate, substitution_matrix_R, num_threads, recombination_map) {
    .Call(`_GenomeAdmixR_simulate_migration_emp_cpp`, input_population_1, input_population_2, marker_positions_R, select_R, pop_sizes, total_runtime, morgan, verbose, track_frequency, track_markers_R, multiplicative_selection, migration_rate, mutation_rate, substitution_matrix_R, num_threads, recombination_map)
}
